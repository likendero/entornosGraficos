...
public class HiloServidor implements Runnable{
    ...
    public void run() {
        ...
        while(control){
            ...
            System.out.println(Cifrar.cifrarAes25664(entrada, clave));
            // se manda un mensaje si la entrada no es un comando
            if(!comandos(entrada)){
               // si existe un cliente en privado solo se le manda a el
                if(chatPrivatoCli != null){
                    
                    chatPrivatoCli.getPw().println(Cifrar.cifrarAes25664("(Privado)Servidor: " + entrada,clave));
                ...
                for(Cliente cli: clientes){
                    try{
                        ...
                        cli.getPw().println(Cifrar.cifrarAes25664("Servidor: " + entrada,clave));
                        cli.getPw().flush();
