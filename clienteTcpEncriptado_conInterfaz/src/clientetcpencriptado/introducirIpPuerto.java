...
public class introducirIpPuerto extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(introducirIpPuerto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                introducirIpPuerto dialog = new introducirIpPuerto(new javax.swing.JFrame(), true);
