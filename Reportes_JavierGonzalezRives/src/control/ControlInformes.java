...
public class ControlInformes implements ActionListener{
     ...
     * @param viewer 
     */
    public ControlInformes(VentanaPrincipal ven, Conexion con) {
        this.ven = ven;
        this.printer = null;
        this.viewer = null;
        this.conexion = con;
    ...
    public void actionPerformed(ActionEvent e) {
        try{
            ...
            // informe 1
            if(e.getSource() == ven.getMiInforme1()){
            ...
            // informe 2
            if(e.getSource() == ven.getMiInforme2()){
             ...
             // informe 3
            if(e.getSource() == ven.getMiInforme3()){
             ...
             // informe 4
            if(e.getSource() == ven.getMiInforme4()){
